...
- The v0.7 Morning Brief route uses numeric subversions: its former three stages map to `v0.7.1`, `v0.7.2`, and `v0.7.3`, followed by the gated `v0.7.4` Legacy Product Retirement & Capability Consolidation milestone; do not introduce phase labels as formal version/stage names. The top-level `v0.7 — Morning Brief` milestone may remain.
