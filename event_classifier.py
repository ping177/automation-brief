...
_CLASSIFIER_SYSTEM_INSTRUCTION = (
    ...
    + 'because an event involves law, litigation, appointments, or personnel. '
    + 'geopolitics covers foreign national-government or state-level political events where a '
    + 'foreign head of government, cabinet reshuffle, minister appointment, national political '
    + 'power, or government-structure change is the core subject; do not classify every '
    + 'appointment or personnel change as geopolitics. china_policy covers major nationwide '
    + 'institutional, regulatory, industry-policy, or policy-reform actions by China\'s central '
    + 'government, State Council departments, or multiple central ministries; nationwide '
    + 'housing-sales rules, pre-sale thresholds, and preference for completed homes are '
    + 'china_policy. macro_policy remains for broader macroeconomic, monetary, or fiscal policy. '
    + 'For mixed events, choose the named category that best matches the dominant subject. '
